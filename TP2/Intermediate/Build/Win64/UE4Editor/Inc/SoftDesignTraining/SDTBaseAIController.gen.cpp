...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASDTBaseAIController_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASDTBaseAIController_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_ASDTBaseAIController()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASDTBaseAIController_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASDTBaseAIController, 1844616711);
	template<> SOFTDESIGNTRAINING_API UClass* StaticClass<ASDTBaseAIController>()
	{
		return ASDTBaseAIController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASDTBaseAIController(Z_Construct_UClass_ASDTBaseAIController, &ASDTBaseAIController::StaticClass, TEXT("/Script/SoftDesignTraining"), TEXT("ASDTBaseAIController"), false, nullptr, nullptr, nullptr);
