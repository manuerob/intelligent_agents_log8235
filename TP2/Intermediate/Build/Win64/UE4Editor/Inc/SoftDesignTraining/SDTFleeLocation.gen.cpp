...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASDTFleeLocation_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASDTFleeLocation_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_ASDTFleeLocation()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASDTFleeLocation_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASDTFleeLocation, 3035196892);
	template<> SOFTDESIGNTRAINING_API UClass* StaticClass<ASDTFleeLocation>()
	{
		return ASDTFleeLocation::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASDTFleeLocation(Z_Construct_UClass_ASDTFleeLocation, &ASDTFleeLocation::StaticClass, TEXT("/Script/SoftDesignTraining"), TEXT("ASDTFleeLocation"), false, nullptr, nullptr, nullptr);
