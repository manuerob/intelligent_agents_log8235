...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USDTPathFollowingComponent_Statics::Class_MetaDataParams[] = {
		{ "ClassGroupNames", "AI" },
		{ "Comment", "/**\n*\n*/" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USDTPathFollowingComponent_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USDTPathFollowingComponent()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USDTPathFollowingComponent_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USDTPathFollowingComponent, 3492923350);
	template<> SOFTDESIGNTRAINING_API UClass* StaticClass<USDTPathFollowingComponent>()
	{
		return USDTPathFollowingComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USDTPathFollowingComponent(Z_Construct_UClass_USDTPathFollowingComponent, &USDTPathFollowingComponent::StaticClass, TEXT("/Script/SoftDesignTraining"), TEXT("USDTPathFollowingComponent"), false, nullptr, nullptr, nullptr);
